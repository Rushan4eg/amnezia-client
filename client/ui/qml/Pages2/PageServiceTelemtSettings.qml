...
PageType {
    ...
    Component.onCompleted: {
        ...
        InstallController.refreshContainerStatus(ContainerEnum.Telemt)
    ...
    Connections {
        ...
        function onSetContainerEnabledFinished(enabled) {
            if (enabled && pendingUpdateAfterEnable) {
                ...
                InstallController.updateContainer(TelemtConfigModel.getConfig(), false)
                return
            }
            isUpdating = false
        ...
        function onContainerStatusRefreshed(status) {
            ...
            if (status === 1) {
                ...
                InstallController.fetchContainerSecret(ContainerEnum.Telemt)
            } else if (status === 2) {
                    ...
                    onToggled: function () {
                        if (checked !== isEnabled) {
                            ...
                            if (checked) {
                                ...
                                InstallController.setContainerEnabled(ContainerEnum.Telemt, true)
                            } else {
                                InstallController.setContainerEnabled(ContainerEnum.Telemt, false)
                            }
                        }
                    }
                }
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        ...
                        ImageButtonType {
                            ...
                            onClicked: {
                                diagLoading = true
                                InstallController.refreshContainerDiagnostics(ContainerEnum.Telemt, parseInt(port))
                            }
                        }
                    }
